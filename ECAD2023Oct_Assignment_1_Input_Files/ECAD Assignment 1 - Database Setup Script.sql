...
values('James Ecader','1980-01-01','School of Infocomm Technology, Ngee Ann Polytechnic','Singapore','(65) 64601234','ecader@np.edu.sg','ecader','Which polytechnic?','Ngee Ann', 1, '2013-01-01 10:05:30' );

insert into Shopper(Name, BirthDate, Address, Country, Phone, EMail, Password, PwdQuestion, PwdAnswer, ActiveStatus, DateEntered) 
values('Peter Tan','1987-05-15','Blk 108, Hougang Ave 1, #04-04','Singapore','(65) 62881111','PeterTan@hotmail.com','PeterTan','wife''s name?','Lucy', 0, '2013-01-01 15:35:20' );

insert into Shopper(Name, BirthDate, Address, Country, Phone, EMail, Password, PwdQuestion, PwdAnswer, ActiveStatus, DateEntered) 
values('Mary Mai','1992-08-09','123, Sunset Way, Spore 555123','Singapore','(65) 62881111','MaryMai@yahoo.com','MaryMai','How many brothers and sisters?','0', 1, '2012-05-01 09:45:23' );
...
'Blooms_of_Sunshine.jpg', 90.00, 300, 1, 72.00, '2023-12-01', '2023-12-31');

insert into Product(ProductTitle, ProductDesc, ProductImage, Price, Quantity, Offered, OfferedPrice, OfferStartDate, OfferEndDate) 
values('Lavish Prosperity', 'Congratulatory Flower Stand. *Includes Handmade Flowers',
'Lavish_Prosperity.jpg', 60.00, 300, 1, 45.00, '2024-01-01', '2024-03-31');
...
'Together_Forever.jpg', 65.00, 100, 1, 50.50, '2024-01-01', '2024-01-31');
...
'Deluxe_Diaper_Cake_Girl.jpg', 160.00, 5, 1, 99.00, '2024-01-01', '2024-03-01');
...
'Blossoming_Health.jpg', 60.00, 100, 1, 29.90, '2024-03-01', '2024-03-31');
...
'Vine_Grace.jpg', 100.00, 2, 1, 70.00, '2024-01-01', '2024-03-31');
...
values(1, 1, 3, 212.00, 14.84, 5.00, 0.00, 231.84,'2020-12-22 09:56:30');
...
'James Ecader', 'School of InfoComm Technology, Ngee Ann Polytechnic', 'Singapore','(65) 64601234', 'ecader@np.edu.sg', '2020-12-23', 'Normal',
'Merry Christmas!', 3, '2020-12-22 10:01:35');
