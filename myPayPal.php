...
$PayPalApiUsername 	= 'sb-kfi6a26653854_api1.business.example.com';//PayPal API Username
$PayPalApiPassword 	= 'EYJ59LZJDUCJZGYK';//Paypal API password
$PayPalApiSignature = 'A2oXgbRoykt-Cb-NZec2cfT1qvD6ArE.8jgGLOnYdD.Yj.nweXy98hDp';//Paypal API Signature
$PayPalCurrencyCode = 'SGD'; //Paypal Currency Code
//URL to redirect to after PayPal has complete the online payment
$PayPalReturnURL 	= 'http://localhost:8081/ASG1-code/ECAD-ASG2/checkoutProcess.php'; 
//URL to redirect to if user clicks cancel                
$PayPalCancelURL 	= 'http://localhost:8081/ASG1-code/ECAD-ASG2/shoppingCart.php'; 
